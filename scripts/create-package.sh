...
# usage:
#
#   scripts/create-package.sh <PACKAGE_NAME> [PACKAGE_NAMESPACE=@namespace WORKSPACE_NAME=packages TEMPLATE_NAME=package]
#
...
# name of the
PACKAGE_NAMESPACE=${2:-"@namespace"}
WORKSPACE_NAME=${3:-"packages"}
